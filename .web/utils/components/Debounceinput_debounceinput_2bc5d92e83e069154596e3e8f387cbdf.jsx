...
export const Debounceinput_debounceinput_2bc5d92e83e069154596e3e8f387cbdf = memo(({children}) => {
...
const reflex___state____state__skillgap_ai___state____state = useContext(StateContexts.reflex___state____state__skillgap_ai___state____state)
    ...
    return(
        jsx(DebounceInput,{css:({ ["height"] : "200px" }),debounceTimeout:300,element:RadixThemesTextArea,onChange:on_change_2d22a3418afe33c214b6366a1e3e4d18,placeholder:"Paste resume here...",value:reflex___state____state__skillgap_ai___state____state.resume_text_rx_state_},)
    )
});
