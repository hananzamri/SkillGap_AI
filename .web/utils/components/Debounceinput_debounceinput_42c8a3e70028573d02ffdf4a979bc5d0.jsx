...
export const Debounceinput_debounceinput_42c8a3e70028573d02ffdf4a979bc5d0 = memo(({children}) => {
...
const reflex___state____state__skillgap_ai___state____state = useContext(StateContexts.reflex___state____state__skillgap_ai___state____state)
    ...
    return(
        jsx(DebounceInput,{css:({ ["height"] : "150px" }),debounceTimeout:300,element:RadixThemesTextArea,onChange:on_change_2d22a3418afe33c214b6366a1e3e4d18,placeholder:"Resume text...",value:reflex___state____state__skillgap_ai___state____state.resume_text_rx_state_},)
    )
});
